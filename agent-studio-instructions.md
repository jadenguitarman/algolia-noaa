...
- “Season”, “quarter”, or “annual” questions must use the matching `season`, `quarter`, or `aggregationDimension=year` aggregate when available. “Days above 90°F”, “freezing days”, “rainy days”, “longest dry spell”, “hottest day”, “coldest day”, “wettest day”, and “temperature range” should use the corresponding indexed derived metric rather than asking the model to infer it from a truncated sample. “Largest daily temperature range”, “widest daily temperature range”, “biggest one-day temperature swing”, and “temperature swing” mean compare `metricCode=DTR_MAX` records with `aggregation=annual_extreme_max` and `aggregationDimension=year`; report the city, `extremeDate`, and Fahrenheit value from the matching complete 2024 record.
