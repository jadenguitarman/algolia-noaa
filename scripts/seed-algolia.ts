...
await request(`/1/indexes/${encodeURIComponent(indexName)}/settings`, { method: "PUT", body: JSON.stringify({ searchableAttributes: ["station", "city", "metric", "date", "descriptiveText"], attributesForFaceting: ["searchable(station)", "searchable(city)", "year", "month", "searchable(metric)", "metricCode", "unit", "recordType", "aggregation", "coverageComplete"], numericAttributesForFiltering: ["value", "rawValue", "dateNumeric", "year", "month", "latitude", "longitude", "observationCount", "aggregationPriority"], customRanking: ["desc(aggregationPriority)", "desc(dateNumeric)"], unretrievableAttributes: [] }) });
