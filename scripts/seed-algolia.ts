...
await request(`/1/indexes/${encodeURIComponent(indexName)}/settings`, { method: "PUT", body: JSON.stringify({ searchableAttributes: ["station", "city", "metric", "date", "weekday", "season", "aggregationValue", "descriptiveText"], attributesForFaceting: ["searchable(station)", "searchable(city)", "year", "month", "searchable(metric)", "metricCode", "unit", "recordType", "aggregation", "aggregationDimension", "searchable(weekday)", "weekdayNumber", "searchable(season)", "quarter", "isWeekend", "coverageComplete", "thresholdLabel"], numericAttributesForFiltering: ["value", "rawValue", "dateNumeric", "year", "month", "latitude", "longitude", "weekdayNumber", "dayOfYear", "observationCount", "expectedObservationCount", "coverageRatio", "aggregationPriority", "threshold"], customRanking: ["desc(aggregationPriority)", "desc(coverageRatio)", "desc(dateNumeric)"], unretrievableAttributes: [] }) });
